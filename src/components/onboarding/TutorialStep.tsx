  ...
  const TUTORIAL_CARDS = [
    {
      ...
      description: t("onboarding.tutorial.step1Desc"),
      icon: TUTORIAL_ICONS[0],
    },
    {
      step: "2",
      title: t("onboarding.tutorial.step2Title"),
      description: t("onboarding.tutorial.step2Desc"),
      icon: TUTORIAL_ICONS[1],
    },
    {
      step: "3",
      title: t("onboarding.tutorial.step3Title"),
      description: t("onboarding.tutorial.step3Desc"),
      icon: TUTORIAL_ICONS[2],
    },
    {
      step: "4",
      title: t("onboarding.tutorial.step4Title"),
      description: t("onboarding.tutorial.step4Desc"),
      icon: TUTORIAL_ICONS[3],
    },
  ];
      ...
      {isSenior && (
        <div className="space-y-2 p-4 bg-info/10 rounded-xl border border-info/20">
          <p className="text-sm font-medium text-info-content">
            {t("onboarding.tutorial.seniorTips")}
          </p>
          <ul className="text-sm text-base-content/70 space-y-1 list-disc list-inside">
            <li>{t("onboarding.tutorial.seniorTip1")}</li>
            <li>{t("onboarding.tutorial.seniorTip2")}</li>
            <li>{t("onboarding.tutorial.seniorTip3")}</li>
          </ul>
        </div>
      )}
