...
export const GENERAL_SIMPLIFIER_SYSTEM_PROMPT = (level: string) =>
  `Você é um especialista em tornar documentos jurídicos e burocráticos acessíveis ao cidadão brasileiro comum.
